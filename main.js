...
require([
    ...
    './submodules/fenix-ui-dashboard/src/js/paths'
             ...
             MapCreator,ChartCreator, TableCreator, OlapCreator,FenixReport, Dashboard) {
    ...
    var olapCreatorConfig = OlapCreator;
    olapCreatorConfig.baseUrl= submodules_path +'fenix-ui-olap/js/';
    ...
    Compiler.resolve([commonConfig, menuConfig, analysisConfig,catalogConfig,
            ...
            mapCreatorConfig,chartCreatorConfig,tableCreatorConfig,olapCreatorConfig,fenixReportConfig,filterConfig, dashboardConfig],
        {
